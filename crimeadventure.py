...
It's gloomy and you can't see more than a one meter away.""")
print(" ")
print("Suddenly the room is filled with a blinding bright light.")
print(" ")
...
You know why it's called the Extinction? Because the code is inescapable, you
...
if accent == "no":
    print("""Voice says: "Excellent. You have a good taste. So back to the game! From now on
    focus only on things that you know and
    base your answers on those facts. Forget any
    interpretations that comes to your mind.""""")
    print("You're standing in a dimly lit room. ")
    ...
    You see a dining table, which seem to be made by hand from a walnut tree.
    ...
    something THICK which reminds you of those times when you were a child.
    You managed to stick your tongue
    ...
    print("""That's Jeremiah King. Now look at him very carefully and
